...
| I want to… | Go here |
|---|---|
| Ask "how do I…" or "does this support…" | [GitHub Discussions](https://github.com/dirghaai/<repository>/discussions) |
| Share a tip, setup, or workflow | [Discussions — Show and tell](https://github.com/dirghaai/<repository>/discussions/categories/show-and-tell) |
| Report a bug | [Open an issue → Bug report](https://github.com/dirghaai/<repository>/issues/new?template=bug.md) |
| Request a feature | [Open an issue → Feature request](https://github.com/dirghaai/<repository>/issues/new?template=feature.md) |
