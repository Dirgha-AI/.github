...
Thanks for helping keep Dirgha and its users safe.

## Reporting a vulnerability

Please **do not** file a public GitHub issue for security problems.

- Preferred: [private vulnerability report](https://github.com/dirghaai/<repository>/security/advisories/new) through GitHub's Security Advisories.
- Alternative: email `security@dirgha.ai` with the word `SECURITY` in the subject and `<repository>` in the body.
